use crate::{
    codec::{base_bitrate, loadavg_cpu_num, EncoderApi, EncoderCfg},
        ...
        match cfg {
            EncoderCfg::HW(config) => {
                ...
                let ctx = EncodeContext {
                    ...
                    rc: DEFAULT_RC,
                    thread_count: loadavg_cpu_num() as _, // ffmpeg's thread_count is used for cpu
                };
...
impl HwDecoder {
    ...
    pub fn new(info: CodecInfo) -> ResultType<Self> {
        let ctx = DecodeContext {
            ...
            thread_count: loadavg_cpu_num() as _,
        };
