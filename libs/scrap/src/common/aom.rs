...
mod webrtc {
    ...
    pub fn enc_cfg(
        ...
        let (q_min, q_max, b) = AomEncoder::convert_quality(cfg.quality, None);
...
impl EncoderApi for AomEncoder {
    ...
    fn set_quality(&mut self, quality: Quality) -> ResultType<()> {
        ...
        let (q_min, q_max, b) = Self::convert_quality(quality, Some(c.rc_max_quantizer));
        if q_min > 0 && q_min < q_max && q_max < 64 {
            c.rc_min_quantizer = q_min;
            c.rc_max_quantizer = q_max;
        }
...
impl AomEncoder {
    ...
    pub fn convert_quality(quality: Quality, current_q_max: Option<u32>) -> (u32, u32, u32) {
