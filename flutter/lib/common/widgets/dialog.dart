...
void confrimDeleteTrustedDevicesDialog(RxList<TrustedDevice> trustedDevices,
    RxList<Uint8List> selectedDevices, RxBool selectAll) {
...
void manageTrustedDeviceDialog() async {
  ...
  gFFI.dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      ...
      content: trustedDevicesTable(trustedDevices, selectedDevices, selectAll),
      actions: [
            ...
            return DataRow(cells: [
              DataCell(Checkbox(
                ...
                onChanged: (value) {
                  ...
                  selectAll.value = selectedDevices.isNotEmpty &&
