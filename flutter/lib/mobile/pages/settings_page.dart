...
class _SettingsState extends State<SettingsPage> with WidgetsBindingObserver {
  ...
  _SettingsState() {
    ...
    _enableTrustedDevices = option2bool(kOptionEnableTrustedDevices,
        bind.mainGetOptionSync(key: kOptionEnableTrustedDevices));
  }
          ...
          onToggle: isOptionFixed(kOptionEnableTrustedDevices)
              ...
              : (v) async {
                  await bind.mainSetOption(
                      key: kOptionEnableTrustedDevices,
                      value: bool2option(kOptionEnableTrustedDevices, v));
                  setState(() {
              ...
              onPressed: selectedDevices.isEmpty
                  ...
                  : () {
                      confrimDeleteTrustedDevicesDialog(
                          trustedDevices, selectedDevices, selectAll);
                    }))
        ],
      ),
      body: FutureBuilder(
