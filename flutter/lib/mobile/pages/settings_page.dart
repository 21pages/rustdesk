...
class _SettingsState extends State<SettingsPage> with WidgetsBindingObserver {
  ...
  _SettingsState() {
    ...
    _enableWebSocket = mainGetBoolOptionSync(kOptionEnableWebSocket);
        ...
        SettingsSection(title: Text(translate("Settings")), tiles: [
          ...
          if (!disabledSettings && !_hideNetwork && !_hideWebSocket)
            SettingsTile.switchTile(
              ...
              initialValue: _enableWebSocket,
              onToggle: isOptionFixed(kOptionEnableWebSocket)
                  ? null
                  : (v) async {
                      await mainSetBoolOption(kOptionEnableWebSocket, v);
                      final newValue =
                          await mainGetBoolOption(kOptionEnableWebSocket);
                      setState(() {
                        _enableWebSocket = newValue;
                      });
                    },
            ),
          SettingsTile(
