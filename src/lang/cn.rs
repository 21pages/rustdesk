...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Create shared address book", "创建共享地址簿"),
        ("Update this address book", "更新此地址簿"),
        ("Delete this address book", "删除此地址簿"),
        ("Sharing passwords within the team", "组内共享密码"),
        ("option_ab_allow_edit_tip", "允许其他人编辑设备和标签（除管理员和创建此地址簿的人）"),
        ("ab_admin_and_creator_permission_tip", "管理员和地址簿创建者可以更新这些设置、编辑设备和标签或删除此地址簿。"),
        ("Are you sure you want to delete address book {}?", "确定要删除地址簿{}吗？"),
        ("My address book", "我的地址簿"),
        ("Shared by the entire team", "整个团队共享"),
        ("You can edit devices and tags", "你可以编辑设备和标签"),
        ("You can update settings or delete this address book", "你可以更新设置或者删除此地址簿"),
        ("You can't edit this address book", "你不能编辑此地址簿"),
        ("Password is shared", "共享密码"),
        ("Password is not shared", "不共享密码"),
        ("Not shared", "不共享"),
        ("Created by {}", "由{}创建"),
