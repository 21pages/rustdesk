...
impl UI {
    ...
    fn check_video_conn_count(&self) {
        check_video_conn_count();
    }

    fn get_video_conn_count(&self) -> i32 {
        get_video_conn_count() as i32
    }
...
impl sciter::EventHandler for UI {
    sciter::dispatch_script_call! {
        ...
        fn check_video_conn_count();
        fn get_video_conn_count();
