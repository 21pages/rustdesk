...
async fn get_http_response_async(
    ...
    log::info!("=====DEBUG===== get_http_response_async is called, tls_type is {:?}, danger_accept_invalid_cert is {:?}, original_danger_accept_invalid_cert is {:?}, url is {:?}", tls_type, danger_accept_invalid_cert, original_danger_accept_invalid_cert, url);
